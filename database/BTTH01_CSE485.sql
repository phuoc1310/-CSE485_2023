...
INSERT INTO tacgia (ma_tgia, ten_tgia) 
...
VALUES (1, "Lòng mẹ", "Lòng mẹ", 2,
			...
			1, "2012/7/23"),
		(2, "Cảm ơn em đã rời xa anh", "Vết mưa", 2,
			...
			3, "2012/2/12"),
		(3, "Cuộc đời có mấy ngày mai?", "Phôi pha", 2, 
		...
		(5, "Đất nước", "Đất nước", 5,
			...
			1, "2010/5/25"),
		(6, "Hard Rock Hallelujah", "Hard Rock Hallelujah", 7,
			...
			6, "2013/9/12"),
		(7, "The Unforgiven", "The Unforgiven", 7,
			...
			1, "2010/5/25"),
		(8, "Nơi tình yêu bắt đầu", "Nơi tình yêu bắt đầu", 1,
			...
			1, "2014/2/3");
		(9, "Love Me Like There’s No Tomorrow", "Love Me Like There’s No Tomorrow", 8,
			...
			1, "2013/2/26"),
		(10, "I\'m stronger", "I\'m stronger", 7,
			...
			2, "2013/8/21"),
		(11, "Ôi Cuộc Sống Mến Thương", "Ôi Cuộc Sống Mến Thương", 5,

        ...
        <div class="row">
                ...
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="../btth01/detail/1/detail.php" class="text-decoration-none">Cây, lá và gió</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="../btth01/detail/2/detail.php" class="text-decoration-none">Cuộc sống mến thương</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="../btth01/detail/3/detail.php" class="text-decoration-none">Lòng mẹ</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="../btth01/detail/4/detail.php" class="text-decoration-none">Phôi pha</a>
                        </h5>
                    </div>
                </div>
            </div>
                ...
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center my-title">
                            <a href="../btth01/detail/5/detail.php" class="text-decoration-none">Nơi tình yêu bắt đầu</a>
                        </h5>
                    </div>
                </div>
            </div>
